...
export const COMPANION_MODELS: CompanionModel[] = [
  ...
  },
  {
    ...
    bio: "Educated in business communications, Ananya is the ideal call girl for visiting corporate executives, tech symposium delegates, and business travelers around the Super Corridor and Brilliant Convention Centre.",
  ...
  },
  {
    ...
    bio: "Warm-hearted, stunningly poised, and a wonderful listener. Simran specializes in unhurried dinner dates, heartfelt escort service, and cultural excursions across Indore.",
  ...
  },
  {
    ...
    bio: "Stunningly glamorous and globally traveled. Natasha is an elite socialite and escort reserved for luxury VIP events, gala nights at Brilliant Convention Centre, and exclusive lounge dates.",
  ...
  },
  {
    ...
    bio: "Radiant, vivacious, and naturally cheerful. Sanjana loves cozy cafe hangouts in New Palasia, late-evening coffee conversations, and relaxed escort service that melts away daily stress.",
  ...
  },
  {
    ...
    bio: "Sharp, articulate, and effortlessly elegant. Kriti is an MBA graduate who understands the corporate tempo, offering peerless escort service for business delegates staying in Indore's premier hotels.",
  ...
  },
  {
    ...
    bio: "Exquisite fashion model with high runway poise and captivating eyes. Kashika is reserved by elite connoisseurs seeking unforgettable luxury escorts in Indore's finest resorts.",
  ...
  },
  {
    ...
    bio: "Brimming with positive vibes, youthful vivacity, and a radiant smile. Tanvi is an ideal escort for guests who appreciate youthful cheer and easygoing, lighthearted conversation.",
